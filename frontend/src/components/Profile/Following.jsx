...
const Following = () => {
  ...
  return (
    <div className="container">
      <Navbar />
      <div className="columns has-background-white mt-5">
        <div className="column box mb-0 has-text-centered is-flex is-flex-direction-column is-align-items-center is-one-quarter">
          <h1 className="is-size-4 has-text-centered mb-4">
           کسانی که دنبال کردید
          </h1>
          <img src={profilePhoto} className="image is-128x128" alt="" />
        </div>
              ...
              return (
                <div className="follower column is-one-fifth" key={item._id}>
                  ...
                  <div className="view-profile has-text-centered">
                    <Link to={`/profile/${item._id}`} className="has-text-success">
                      مشاهده
                    </Link>
                  </div>
                </div>
